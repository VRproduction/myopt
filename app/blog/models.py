...
class WhoTitle1(models.Model):
    ...
    who = models.ForeignKey(WhoWeAre,on_delete=models.CASCADE, related_name="title_1")
...
class WhoTitle2(models.Model):
    name = models.CharField(max_length=200)
    who = models.ForeignKey(WhoWeAre,on_delete=models.CASCADE, related_name="title_2")
